...
用法：
  python -m fanisl.knowledge.spotcheck sample [n]                  # 随机抽 n 条未查单元（默认 10）
  python -m fanisl.knowledge.spotcheck record <unit_id> <verdict> [note]   # faithful|unfaithful|unclear
  python -m fanisl.knowledge.spotcheck stats
"""

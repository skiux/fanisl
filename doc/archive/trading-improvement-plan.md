...
> **[已完成/存档]** 本计划已全部落地并入 main（多账户/scorecard v2/影子/拒绝力）。后续演进见 [trading-eval-repositioning.md](../trading-eval-repositioning.md)（2026-07 重定位）与 [research-capstone.md](../research/research-capstone.md)。

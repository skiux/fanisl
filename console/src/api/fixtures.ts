...
export const stocks: StocksAccount = {
  ...
  coverage_detail: '持仓数量来自钱包；只有成交记录推导的股数与钱包里的正股和代币化股票合计股数一致时，才显示成本与盈亏。',
  // AAPL 同时保留两种持有形态，合计市值仍是 $460；敞口图的十二个标的不变。
  equity_holdings: [{
    asset_code: 'EQ_AAPL',
    name: 'Apple Inc.',
    symbol: 'AAPL',
  ...
  positions: [{
    ...
    withdrawing_qty: 0,
    total_qty: 2,
    wallet_price_usd: 230,
    wallet_value_usd: 460,
    bid_usd: 229.9,
    ask_usd: 230.1,
    mark_price_usd: 230,
    spread_bps: 8.7,
